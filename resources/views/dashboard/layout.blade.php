...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="assets/dashboardss/plugins/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="assets/dashboard/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 ml-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="assets/dashboard/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  پیمان احمدی
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="assets/dashboard/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  سارا وکیلی
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user1-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user7-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user3-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user5-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user6-128x128.jpg">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="assets/dashboard/dist/img/user8-128x128.jpg">
